	...
	public class FinanceQuestions extends JPanel implements QuestionPanel{
	    ...
	    public FinanceQuestions() {
	    	setLayout(null);
	    	setBackground(new Color(0x0B132B));
	    	
	    	  JTextArea textArea = new JTextArea("Question: How skilled do you consider yourself in financial analysis, including risk assessment and investment evaluation?");
	    	...
	    	JTextArea textArea1 = new JTextArea("Question: Have you managed financial portfolios or participated in financial planning? How effective were your strategies?");
	        ...
	        choice2 = new Choices();
		  	...
		  	JTextArea textArea2 = new JTextArea("Question: How skilled are you in financial forecasting and interpreting financial data to guide business strategies?");
	        ...
	        choice3.setBackground(getBackground()); 
		  	...
		  	JTextArea textArea3 = new JTextArea("Question: How experienced are you in capital budgeting, and can you share an example where you successfully managed a capital budgeting process that led to sound investment decisions?");
	        ...
	        choice4 = new Choices();
		  	...
		  	JTextArea textArea4 = new JTextArea("Question: How effective are your debt management skills, including optimizing debt structures and managing debt levels to enhance financial stability?");
	        ...
	        choice5 = new Choices();
		  	...
		  	JTextArea textArea5 = new JTextArea("Question: How proficient are you in managing cash flow, and can you describe a situation where your cash flow management strategies contributed to improved liquidity and financial health?");
	        ...
	        choice6 = new Choices();
		  	...
		  	JTextArea textArea6 = new JTextArea("Question: How well do you ensure financial compliance within your organization, and can you provide an example where your attention to financial regulations positively impacted the company's operations?");
	        ...
	        choice7 = new Choices();
		  	...
		  	JTextArea textArea7 = new JTextArea("Question: How strategic are you in tax planning, and can you discuss a scenario where your tax strategy contributed to cost savings or overall financial efficiency?");
	        ...
	        choice8 = new Choices();
		  	...
		  	JTextArea textArea8 = new JTextArea("Question: How well do you identify and mitigate financial risks, and can you share a situation where your risk management approach protected the organization from adverse financial outcomes?");
	        ...
	        choice9 = new Choices();
		  	...
		  	JTextArea textArea9 = new JTextArea("Question: How effectively do you communicate complex financial information to non-finance colleagues or stakeholders, and can you provide an example of a situation where your ability to convey financial concepts positively impacted decision-making?");
