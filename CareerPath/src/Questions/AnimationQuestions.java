	...
	public class AnimationQuestions extends JPanel implements QuestionPanel{
	    ...
	    public AnimationQuestions() {
	    	setLayout(null);
	    	setBackground(new Color(0x0B132B));
	    	
	    	  JTextArea textArea = new JTextArea("Question: How would you rate your proficiency in using animation software, such as Adobe After Effects or Blender, to create dynamic and engaging animations?");
	    	...
	    	JTextArea textArea1 = new JTextArea("Question:  Describe a project where you had to convey a complex message through animation. How successful were you in making the content visually engaging and easy to understand?");
	        ...
	        choice2 = new Choices();
		  	...
		  	JTextArea textArea2 = new JTextArea("Question:  Rate your ability to create character animations that convey emotion and personality effectively. ");
	        ...
	        choice3.setBackground(getBackground()); 
		  	...
		  	JTextArea textArea3 = new JTextArea("Question:  How do you approach storytelling in your animations to captivate the audience and communicate a narrative effectively? ");
	        ...
	        choice4 = new Choices();
		  	...
		  	JTextArea textArea4 = new JTextArea("Question: Describe a situation where you had to collaborate with a team on an animated project. How well did you contribute to the overall creative process?");
	        ...
	        choice5 = new Choices();
		  	...
		  	JTextArea textArea5 = new JTextArea("Question:  Rate your attention to detail in ensuring smooth and realistic motion in your animations.");
	        ...
	        choice6 = new Choices();
		  	...
		  	JTextArea textArea6 = new JTextArea("Question: How comfortable are you with experimenting with different animation techniques and styles to achieve unique and innovative results?");
	        ...
	        choice7 = new Choices();
		  	...
		  	JTextArea textArea7 = new JTextArea("Question: Evaluate your ability to meet deadlines and deliver high-quality animations within a specified timeframe");
	        ...
	        choice8 = new Choices();
		  	...
		  	JTextArea textArea8 = new JTextArea("Question: How do you incorporate feedback from clients or team members into your animation projects, and how well do you handle revisions?");
	        ...
	        choice9 = new Choices();
		  	...
		  	JTextArea textArea9 = new JTextArea("Question: Rate your proficiency in optimizing animations for various platforms and ensuring compatibility with different playback devices");
