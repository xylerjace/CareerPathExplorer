	...
	public class DraftingQuestions extends JPanel implements QuestionPanel{
	    ...
	    public DraftingQuestions() {
	    	setLayout(null);
	    	setBackground(new Color(0x0B132B));
	    	
	    	  JTextArea textArea = new JTextArea("Question: Rate your proficiency in creating detailed and accurate technical drawings or schematics.");
	    	...
	    	JTextArea textArea1 = new JTextArea("Question: How well do you communicate complex engineering ideas through clear and concise technical drawings?");
	        ...
	        choice2 = new Choices();
		  	...
		  	JTextArea textArea2 = new JTextArea("Question: Describe a situation where your drafting skills played a crucial role in conveying critical information to team members or stakeholders.");
	        ...
	        choice3.setBackground(getBackground()); 
		  	...
		  	JTextArea textArea3 = new JTextArea("Question: Evaluate your ability to incorporate feedback and revisions into your technical drawings.");
	        ...
	        choice4 = new Choices();
		  	...
		  	JTextArea textArea4 = new JTextArea("Question: When working on a collaborative project, how effective are you in ensuring consistency and clarity in the technical documentation?");
	        ...
	        choice5 = new Choices();
		  	...
		  	JTextArea textArea5 = new JTextArea("Question: How would you rate your attention to detail when creating technical drawings or specifications?");
	        ...
	        choice6 = new Choices();
		  	...
		  	JTextArea textArea6 = new JTextArea("Question: Describe your experience with using drafting software and tools. How proficient are you in leveraging these resources?");
	        ...
	        choice7 = new Choices();
		  	...
		  	JTextArea textArea7 = new JTextArea("Question:  How do you approach balancing the need for precision with the need to complete drafting tasks within a specified timeframe?");
	        ...
	        choice8 = new Choices();
		  	...
		  	JTextArea textArea8 = new JTextArea("Question:  Rate your ability to translate conceptual ideas into accurate and practical technical drawings.");
	        ...
	        choice9 = new Choices();
		  	...
		  	JTextArea textArea9 = new JTextArea("Question:  How well do you incorporate industry standards and best practices into your technical drawings?");
