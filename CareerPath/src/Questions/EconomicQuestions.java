	...
	public class EconomicQuestions extends JPanel implements QuestionPanel{
	    ...
	    public EconomicQuestions() {
	    	setLayout(null);
	    	setBackground(new Color(0x0B132B));
	    	
	    	  JTextArea textArea = new JTextArea("Question:  How confident are you in your understanding and application of economic principles in real-world scenarios?");
	    	...
	    	JTextArea textArea1 = new JTextArea("Question: Can you discuss an instance where your economic analysis influenced a critical decision? How impactful were your insights?");
	        ...
	        choice2 = new Choices();
		  	...
		  	JTextArea textArea2 = new JTextArea("Question: How well can you apply economic theories and concepts to analyze market trends and make informed business decisions?");
	        ...
	        choice3.setBackground(getBackground()); 
		  	...
		  	JTextArea textArea3 = new JTextArea("Question: How well can you apply economic theories and concepts to analyze market trends and make informed business decisions?");
	        ...
	        choice4 = new Choices();
		  	...
		  	JTextArea textArea4 = new JTextArea("Question:How well do you stay informed about the economic landscape of your industry, and how does this knowledge influence your strategic planning and business decisions?");
	        ...
	        choice5 = new Choices();
		  	...
		  	JTextArea textArea5 = new JTextArea("Question: How do you formulate resource allocation strategies based on economic principles to optimize efficiency and achieve organizational objectives?");
	        ...
	        choice6 = new Choices();
		  	...
		  	JTextArea textArea6 = new JTextArea("Question: How well do you understand and analyze the economic impact of emerging technological trends on industries, and how have you applied this understanding in strategic planning?");
	        ...
	        choice7 = new Choices();
		  	...
		  	JTextArea textArea7 = new JTextArea("Question: How committed are you to continuous education and training in economic principles, and how has this commitment contributed to your professional development?");
	        ...
	        choice8 = new Choices();
		  	...
		  	JTextArea textArea8 = new JTextArea("Question: How comfortable are you in publicly speaking about economic topics, and can you share an instance where you effectively communicated economic concepts to a non-expert audience?");
	        ...
	        choice9 = new Choices();
		  	...
		  	JTextArea textArea9 = new JTextArea("Question: How skilled are you in scenario planning within an economic context, and can you describe a situation where your ability to anticipate and plan for various economic scenarios contributed to strategic decision-making?");
