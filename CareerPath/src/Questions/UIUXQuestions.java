...
public class UIUXQuestions extends JPanel implements QuestionPanel {
	...
	Choices choice9;
	Choices choice10;
    public UIUXQuestions() {
    	setLayout(null);
    	setBackground(new Color(0x0B132B));
    	
    	  JTextArea textArea = new JTextArea("Question: How would you rate your proficiency in using design tools such as Sketch, Figma, or Adobe XD?");
    	...
    	JTextArea textArea1 = new JTextArea("Question: What is your level of expertise in creating wireframes for user interfaces?");
        ...
        add(textArea1);
         choice2 = new Choices();
	  	...
	  	JTextArea textArea2 = new JTextArea("Question: How comfortable are you with designing responsive and mobile-friendly interfaces? ");
        ...
        choice3.setBackground(getBackground()); 
	  	...
	  	JTextArea textArea3 = new JTextArea("Question: Rate your understanding of user-centered design principles. ");
        ...
        add(textArea3);
         choice4 = new Choices();
	  	...
	  	JTextArea textArea4 = new JTextArea("Question: What is your proficiency in creating high-fidelity prototypes for user testing?");
        ...
        add(textArea4);
         choice5 = new Choices();
	  	...
	  	JTextArea textArea5 = new JTextArea("Question: How would you rate your skills in conducting user research and usability testing?");
        ...
        add(textArea5);
         choice6 = new Choices();
	  	...
	  	JTextArea textArea6 = new JTextArea("Question: What is your level of expertise in ensuring accessibility in your designs for users with disabilities?");
        ...
        add(textArea6);
         choice7 = new Choices();
	  	...
	  	JTextArea textArea7 = new JTextArea("Question: How comfortable are you with creating design systems and maintaining design consistency?");
        ...
        add(textArea7);
         choice8 = new Choices();
	  	...
	  	JTextArea textArea8 = new JTextArea("Question: Describe your experience in collaborating with development teams to implement your design vision");
        ...
        add(textArea8);
         choice9 = new Choices();
	  	...
	  	JTextArea textArea9 = new JTextArea("Question: How confident are you in your ability to incorporate user feedback into the design iteration process?");
