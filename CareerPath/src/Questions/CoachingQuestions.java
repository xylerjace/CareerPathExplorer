	...
	public class CoachingQuestions extends JPanel implements QuestionPanel{
	    ...
	    public CoachingQuestions() {
	    	setLayout(null);
	    	setBackground(new Color(0x0B132B));
	    	
	    	  JTextArea textArea = new JTextArea("Question: How confident are you in your capability to guide individuals or teams towards achieving their goals through coaching?");
	    	...
	    	JTextArea textArea1 = new JTextArea("Question: Have you successfully helped individuals overcome challenges or improve performance through coaching methods? How impactful were your coaching strategies?");
	        ...
	        choice2 = new Choices();
		  	...
		  	JTextArea textArea2 = new JTextArea("Question: How adept are you in collaboratively setting and aligning goals with individuals or teams during coaching sessions?");
	        ...
	        choice3.setBackground(getBackground()); 
		  	...
		  	JTextArea textArea3 = new JTextArea("Question: How well do you demonstrate active listening during coaching sessions?");
	        ...
	        choice4 = new Choices();
		  	...
		  	JTextArea textArea4 = new JTextArea("Question: How effective are you in delivering constructive feedback during coaching sessions?");
	        ...
	        choice5 = new Choices();
		  	...
		  	JTextArea textArea5 = new JTextArea("Question: How would you rate your ability to demonstrate empathy and emotional intelligence in coaching interactions?");
	        ...
	        choice6 = new Choices();
		  	...
		  	JTextArea textArea6 = new JTextArea("Question: How skilled are you in facilitating conflict resolution during coaching sessions, whether at the individual or team level?");
	        ...
	        choice7 = new Choices();
		  	...
		  	JTextArea textArea7 = new JTextArea("Question:  How do you integrate strategies to build resilience in individuals or teams during coaching?");
	        ...
	        choice8 = new Choices();
		  	...
		  	JTextArea textArea8 = new JTextArea("Question: How successful have you been in facilitating behavioral change through coaching methods?");
	        ...
	        choice9 = new Choices();
		  	...
		  	JTextArea textArea9 = new JTextArea("Question: How proficient are you in coaching individuals for leadership development?");
