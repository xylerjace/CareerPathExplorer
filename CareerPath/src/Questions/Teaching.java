	...
	public class Teaching extends JPanel implements QuestionPanel{
	    ...
	    public Teaching() {
	    	...
	    	setBackground(new Color(0x0B132B));
	    	  ...
	    	  JTextArea textArea = new JTextArea("Question:  How would you rate your ability to effectively convey complex information to learners/trainees?");
	    	...
	    	JTextArea textArea1 = new JTextArea("Question:Can you describe a situation where your teaching/training skills significantly impacted the learning outcomes? How satisfied were you with the results?");
	        ...
	        choice2 = new Choices();
		  	...
		  	JTextArea textArea2 = new JTextArea("Question: How proficient are you in integrating technology into your teaching/training methods?");
	        ...
	        choice3.setBackground(getBackground()); 
		  	...
		  	JTextArea textArea3 = new JTextArea("Question: How effectively do you design assessments and provide constructive feedback to facilitate the learning process?");
	        ...
	        choice4 = new Choices();
		  	...
		  	JTextArea textArea4 = new JTextArea("Question: How do you connect theoretical concepts to real-world applications in your teaching/training?");
	        ...
	        choice5 = new Choices();
		  	...
		  	JTextArea textArea5 = new JTextArea("Question: How effectively do you collaborate with other educators or trainers in team-based training programs?");
	        ...
	        choice6 = new Choices();
		  	...
		  	JTextArea textArea6 = new JTextArea("Question: How effectively do you collaborate with other educators or trainers in team-based training programs?");
	        ...
	        choice7 = new Choices();
		  	...
		  	JTextArea textArea7 = new JTextArea("Question: How often do you employ innovative teaching approaches to capture the interest and curiosity of your learners?");
	        ...
	        choice8 = new Choices();
		  	...
		  	JTextArea textArea8 = new JTextArea("Question:  How often do you incorporate interactive learning activities in your teaching/training sessions?");
