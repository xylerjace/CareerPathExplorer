...
public class GameDevQuestions extends JPanel implements QuestionPanel{
	...
	Choices choice9;
	Choices choice10;
    public GameDevQuestions() {
    	setLayout(null);
    	setBackground(new Color(0x0B132B));
    	
    	  JTextArea textArea = new JTextArea("Question: How would you rate your proficiency in using game development engines such as Unity or Unreal Engine?");
    	...
    	JTextArea textArea1 = new JTextArea("Question: What is your level of expertise in programming languages commonly used in game development ");
        ...
        add(textArea1);
         choice2 = new Choices();
	  	...
	  	JTextArea textArea2 = new JTextArea("Question: How comfortable are you with 3D modeling and animation tools for game assets?");
        ...
        choice3.setBackground(getBackground()); 
	  	...
	  	JTextArea textArea3 = new JTextArea("Question: Rate your understanding of game design principles, including mechanics, levels, and user experience");
        ...
        add(textArea3);
         choice4 = new Choices();
	  	...
	  	JTextArea textArea4 = new JTextArea("Question: What is your proficiency in optimizing games for performance, considering factors like frame rate and memory usage?");
        ...
        add(textArea4);
         choice5 = new Choices();
	  	...
	  	JTextArea textArea5 = new JTextArea("Question: How confident are you in your knowledge of game physics and collision detection?");
        ...
        add(textArea5);
         choice6 = new Choices();
	  	...
	  	JTextArea textArea6 = new JTextArea("Question: Have you developed games for specific platforms (e.g., PC, console, mobile)? If so, please specify");
        ...
        add(textArea6);
         choice7 = new Choices();
	  	...
	  	JTextArea textArea7 = new JTextArea("Question: How would you rate your skills in debugging and troubleshooting game code?");
        ...
        add(textArea7);
         choice8 = new Choices();
	  	...
	  	JTextArea textArea8 = new JTextArea("Question: Describe your experience in implementing multiplayer functionality or online features in games");
        ...
        add(textArea8);
         choice9 = new Choices();
	  	...
	  	JTextArea textArea9 = new JTextArea("Question: How do you stay updated with the latest trends and technologies in the game development industry?");
