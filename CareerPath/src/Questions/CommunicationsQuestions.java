...
public class CommunicationsQuestions extends JPanel implements QuestionPanel{
	...
	Choices choice9;
	Choices choice10;
    public CommunicationsQuestions() {
    	setLayout(null);
    	setBackground(new Color(0x0B132B));
    	
    	  JTextArea textArea = new JTextArea("Question: How would you rate your verbal communication skills in a professional setting?");
    	...
    	JTextArea textArea1 = new JTextArea("Question: How do you adjust your communication style when interacting with technical and non-technical stakeholders?");
        ...
        add(textArea1);
         choice2 = new Choices();
	  	...
	  	JTextArea textArea2 = new JTextArea("Question: How comfortable are you with delivering presentations to both small and large audiences?");
        ...
        choice3.setBackground(getBackground()); 
	  	...
	  	JTextArea textArea3 = new JTextArea("Question: Rate your ability to communicate complex technical information to non-technical stakeholders");
        ...
        add(textArea3);
         choice4 = new Choices();
	  	...
	  	JTextArea textArea4 = new JTextArea("Question: How would you rate your written communication skills, including emails, reports, and documentation?");
        ...
        add(textArea4);
         choice5 = new Choices();
	  	...
	  	JTextArea textArea5 = new JTextArea("Question: How do you ensure effective communication in virtual or remote work settings?");
        ...
        add(textArea5);
         choice6 = new Choices();
	  	...
	  	JTextArea textArea6 = new JTextArea("Question: Describe a situation where you had to communicate a difficult or unpopular decision to a team. How did you approach it?");
        ...
        add(textArea6);
         choice7 = new Choices();
	  	...
	  	JTextArea textArea7 = new JTextArea("Question: How do you tailor your communication for different audiences, such as clients, colleagues, and superiors?");
        ...
        add(textArea7);
         choice8 = new Choices();
	  	...
	  	JTextArea textArea8 = new JTextArea("Question: How comfortable are you with receiving and providing constructive feedback in a professional context?");
        ...
        add(textArea8);
         choice9 = new Choices();
	  	...
	  	JTextArea textArea9 = new JTextArea("Question: How do you handle conflicts arising from miscommunication within a team, and what steps do you take to promote resolution and growth?");
