...
public class GraphicDesignQuestions extends JPanel implements QuestionPanel{
	...
	Choices choice9;
	Choices choice10;
    public GraphicDesignQuestions() {
    	setLayout(null);
    	setBackground(new Color(0x0B132B));
    	
    	  JTextArea textArea = new JTextArea("Question:How would you rate your proficiency in using graphic design software, such as Adobe Creative Suite, to create visually compelling and effective designs?");
    	...
    	JTextArea textArea1 = new JTextArea("Question:Describe a project where you had to balance creativity with adherence to brand guidelines. How well were you able to maintain brand consistency in your designs?");
        ...
        add(textArea1);
         choice2 = new Choices();
	  	...
	  	JTextArea textArea2 = new JTextArea("Question:Rate your ability to translate conceptual ideas into visually appealing designs that resonate with the target audience");
        ...
        choice3.setBackground(getBackground()); 
	  	...
	  	JTextArea textArea3 = new JTextArea("Question: How well do you incorporate user experience (UX) principles into your graphic design work to enhance usability and accessibility?");
        ...
        add(textArea3);
         choice4 = new Choices();
	  	...
	  	JTextArea textArea4 = new JTextArea("Question: Describe a situation where you had to work under tight deadlines to deliver high-quality graphic designs. How did you manage your time and maintain design quality?");
        ...
        add(textArea4);
         choice5 = new Choices();
	  	...
	  	JTextArea textArea5 = new JTextArea("Question: Rate your attention to detail when it comes to ensuring accuracy in typography, color schemes, and other design elements.");
        ...
        add(textArea5);
         choice6 = new Choices();
	  	...
	  	JTextArea textArea6 = new JTextArea("Question: How do you approach receiving and incorporating constructive feedback into your design work?");
        ...
        add(textArea6);
         choice7 = new Choices();
	  	...
	  	JTextArea textArea7 = new JTextArea("Question: Evaluate your ability to adapt your design style to different industries or target audiences.");
        ...
        add(textArea7);
         choice8 = new Choices();
	  	...
	  	JTextArea textArea8 = new JTextArea("Question:How comfortable are you with staying updated on the latest design trends and incorporating them into your work when appropriate?");
        ...
        add(textArea8);
         choice9 = new Choices();
	  	...
	  	JTextArea textArea9 = new JTextArea("Question:Rate your proficiency in creating responsive designs that look appealing and function well across various platforms and devices.");
