	...
	public class DataAnalysisQuestions extends JPanel implements QuestionPanel{
	    ...
	    public DataAnalysisQuestions() {
	    	setLayout(null);
	    	setBackground(new Color(0x0B132B));
	    	
	    	  JTextArea textArea = new JTextArea("Question: How would you rate your proficiency in using data analysis tools such as Excel or Google Sheets?");
	    	...
	    	JTextArea textArea1 = new JTextArea("Question: What is your level of expertise in cleaning and preprocessing data for analysis?");
	        ...
	        choice2 = new Choices();
		  	...
		  	JTextArea textArea2 = new JTextArea("Question: How confident are you in your knowledge of statistical methods for data analysis ");
	        ...
	        choice3.setBackground(getBackground()); 
		  	...
		  	JTextArea textArea3 = new JTextArea("Question: What is your proficiency in using data visualization tools ");
	        ...
	        choice4 = new Choices();
		  	...
		  	JTextArea textArea4 = new JTextArea("Question: How comfortable are you with machine learning concepts and their application in data analysis?");
	        ...
	        choice5 = new Choices();
		  	...
		  	JTextArea textArea5 = new JTextArea("Question: How would you rate your ability to derive actionable insights from data analysis?");
	        ...
	        choice6 = new Choices();
		  	...
		  	JTextArea textArea6 = new JTextArea("Question: Describe your experience in handling missing or incomplete data in a dataset.");
	        ...
	        choice7 = new Choices();
		  	...
		  	JTextArea textArea7 = new JTextArea("Question: How confident are you in your ability to perform exploratory data analysis?");
	        ...
	        choice8 = new Choices();
		  	...
		  	JTextArea textArea8 = new JTextArea("Question: What is your proficiency in using programming languages (e.g., Python, R) for data analysis tasks?");
	        ...
	        choice9 = new Choices();
		  	...
		  	JTextArea textArea9 = new JTextArea("Question: How confident are you in your ability to perform exploratory data analysis?");
