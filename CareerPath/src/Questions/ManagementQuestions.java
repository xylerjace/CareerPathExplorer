	...
	public class ManagementQuestions extends JPanel implements QuestionPanel{
	    ...
	    public ManagementQuestions() {
	    	...
	    	setBackground(new Color(0x0B132B));
	    	  ...
	    	  JTextArea textArea = new JTextArea("Question: How would you rate your ability to lead and motivate teams to achieve set objectives?");
	    	...
	    	JTextArea textArea1 = new JTextArea("Question: Can you describe a situation where your management skills significantly improved team performance? How satisfied were you with the results?");
	        ...
	        choice2 = new Choices();
		  	...
		  	JTextArea textArea2 = new JTextArea("Question:How would you evaluate your effectiveness in setting goals and monitoring progress within your team?");
	        ...
	        choice3.setBackground(getBackground()); 
		  	...
		  	JTextArea textArea3 = new JTextArea("Question:  How would you rate your adaptability in adjusting your management style to different team members or situations?");
	        ...
	        choice4 = new Choices();
		  	...
		  	JTextArea textArea4 = new JTextArea("Question:How would you rate your time management skills in prioritizing tasks and ensuring efficient workflow as a leader?");
	        ...
	        choice5 = new Choices();
		  	...
		  	JTextArea textArea5 = new JTextArea("Question: How would you assess your communication skills in ensuring clear and effective communication within your team?");
	        ...
	        choice6 = new Choices();
		  	...
		  	JTextArea textArea6 = new JTextArea("Question:How well do you align individual and team goals with the overall organizational objectives to ensure a cohesive and purpose-driven team?");
	        ...
	        choice7 = new Choices();
		  	...
		  	JTextArea textArea7 = new JTextArea("Question:  How proactive are you in identifying potential issues or obstacles within projects and taking preventive measures to address them before they escalate?");
	        ...
	        choice8 = new Choices();
		  	...
		  	JTextArea textArea8 = new JTextArea("Question:  How proficiently do you leverage collaboration tools and technologies to enhance communication and coordination within your team?");
	        ...
	        choice9 = new Choices();
		  	...
		  	JTextArea textArea9 = new JTextArea("Question: How open are you to receiving feedback from your team, and how do you use that feedback to enhance your leadership approach?");
