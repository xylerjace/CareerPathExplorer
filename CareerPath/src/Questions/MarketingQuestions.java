...
public class MarketingQuestions extends JPanel implements QuestionPanel{
    ...
    public MarketingQuestions() {
    	...
    	setBackground(new Color(0x0B132B));
    	  ...
    	  JTextArea textArea = new JTextArea("Question: How would you rate your ability to conduct market research and analyze consumer trends to inform marketing strategies?");
    	...
    	JTextArea textArea1 = new JTextArea("Question:  Describe a successful marketing campaign you've led. How effective were your efforts in reaching and engaging the target audience?");
        ...
        add(textArea1);
         choice2 = new Choices();
	  	...
	  	JTextArea textArea2 = new JTextArea("Question: Rate your proficiency in utilizing digital marketing channels, such as social media and email, to promote products or services.");
        ...
        choice3.setBackground(getBackground()); 
	  	...
	  	JTextArea textArea3 = new JTextArea("Question: How well do you tailor marketing messages to resonate with diverse target demographics?");
        ...
        add(textArea3);
         choice4 = new Choices();
	  	...
	  	JTextArea textArea4 = new JTextArea("Question: In a competitive market, how effective are you in positioning a product or service to stand out from competitors?");
        ...
        add(textArea4);
         choice5 = new Choices();
	  	...
	  	JTextArea textArea5 = new JTextArea("Question:Rate your creativity in developing compelling and memorable marketing content that drives brand awareness.");
        ...
        add(textArea5);
         choice6 = new Choices();
	  	...
	  	JTextArea textArea6 = new JTextArea("Question: How do you measure the success of a marketing campaign, and how comfortable are you with adjusting strategies based on performance metrics?");
        ...
        add(textArea6);
         choice7 = new Choices();
	  	...
	  	JTextArea textArea7 = new JTextArea("Question: Describe your experience with customer relationship management (CRM) systems and how you leverage them to enhance marketing efforts");
        ...
        add(textArea7);
         choice8 = new Choices();
	  	...
	  	JTextArea textArea8 = new JTextArea("Question: How do you approach adapting marketing strategies to accommodate changes in consumer behavior or industry trends?");
        ...
        add(textArea8);
         choice9 = new Choices();
	  	...
	  	JTextArea textArea9 = new JTextArea("Question: Rate your ability to collaborate with cross-functional teams, such as sales and product development, to align marketing efforts with overall business goals.");
