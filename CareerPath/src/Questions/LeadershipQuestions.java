...
public class LeadershipQuestions extends JPanel implements QuestionPanel{
    ...
    public LeadershipQuestions() {
    	setLayout(null);
    	setBackground(new Color(0x0B132B));
    	
    	  JTextArea textArea = new JTextArea("Question: How would you rate your ability to inspire and motivate a team towards a common goal?");
    	...
    	JTextArea textArea1 = new JTextArea("Question: Describe a situation where you provided effective leadership in a challenging project. What was the outcome?");
        ...
        add(textArea1);
         choice2 = new Choices();
	  	...
	  	JTextArea textArea2 = new JTextArea("Question: How effectively do you foster collaboration and inclusivity within your team?");
        ...
        choice3.setBackground(getBackground()); 
	  	...
	  	JTextArea textArea3 = new JTextArea("Question: When making team decisions, how well do you ensure collective input and consensus?");
        ...
        add(textArea3);
         choice4 = new Choices();
	  	...
	  	JTextArea textArea4 = new JTextArea("Question: How successfully do you balance supportiveness with holding team members accountable for their responsibilities?");
        ...
        add(textArea4);
         choice5 = new Choices();
	  	...
	  	JTextArea textArea5 = new JTextArea("Question: Have you led cross-functional or multidisciplinary teams? If so, how well did you handle the challenges and achieve success?");
        ...
        add(textArea5);
         choice6 = new Choices();
	  	...
	  	JTextArea textArea6 = new JTextArea("Question: In dealing with conflicts within your team, how proficiently do you promote resolution and growth?");
        ...
        add(textArea6);
         choice7 = new Choices();
	  	...
	  	JTextArea textArea7 = new JTextArea("Question: How actively do you encourage professional development and skill growth among team members in a leadership role?");
        ...
        add(textArea7);
         choice8 = new Choices();
	  	...
	  	JTextArea textArea8 = new JTextArea("Question: How effectively do you communicate expectations and goals to your team, aligning them with organizational objectives?");
        ...
        add(textArea8);
         choice9 = new Choices();
	  	...
	  	JTextArea textArea9 = new JTextArea("Question: Describe a time when you successfully led a team through a challenging change or transition. How well did you employ strategies to navigate this situation?");
