...
public class ProgrammingQuestions extends JPanel implements QuestionPanel{
    ...
    public ProgrammingQuestions() {
    	...
    	setBackground(new Color(0x0B132B));
    	  ...
    	  JTextArea textArea = new JTextArea("Question: How would you rate your proficiency in using object-oriented programming (OOP) concepts?");
    	...
    	JTextArea textArea1 = new JTextArea("Question: How comfortable are you with debugging and troubleshooting code?");
        ...
        add(textArea1);
         choice2 = new Choices();
	  	...
	  	JTextArea textArea2 = new JTextArea("Question: What is your level of expertise in developing applications with a specific programming language (e.g., Python, Java)?");
        ...
        choice3.setBackground(getBackground()); 
	  	...
	  	JTextArea textArea3 = new JTextArea("Question: How would you rate your ability to optimize code for performance and efficiency?");
        ...
        add(textArea3);
         choice4 = new Choices();
	  	...
	  	JTextArea textArea4 = new JTextArea("Question: In which programming languages do you consider yourself proficient?");
        ...
        add(textArea4);
         choice5 = new Choices();
	  	...
	  	JTextArea textArea5 = new JTextArea("Question: How confident are you in your understanding of data structures and algorithms?");
        ...
        add(textArea5);
         choice6 = new Choices();
	  	...
	  	JTextArea textArea6 = new JTextArea("Question: How would you rate your skills in building and consuming web APIs?");
        ...
        add(textArea6);
         choice7 = new Choices();
	  	...
	  	JTextArea textArea7 = new JTextArea("Question: What is your level of expertise in database management and SQL?");
        ...
        add(textArea7);
         choice8 = new Choices();
	  	...
	  	JTextArea textArea8 = new JTextArea("Question: How comfortable are you with version control systems like Git?");
        ...
        add(textArea8);
         choice9 = new Choices();
	  	...
	  	JTextArea textArea9 = new JTextArea("Question: What is your proficiency in developing and deploying applications in a cloud environment (e.g., AWS, Azure)?");
