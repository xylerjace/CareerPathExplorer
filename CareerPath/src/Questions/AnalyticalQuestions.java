	...
	public class AnalyticalQuestions extends JPanel implements QuestionPanel{
	    ...
	    public AnalyticalQuestions() {
	    	setLayout(null);
	    	setBackground(new Color(0x0B132B));
	    	
	    	  JTextArea textArea = new JTextArea("Question:Evaluate your proficiency in breaking down complex technical concepts into manageable components for analysis.");
	    	...
	    	JTextArea textArea1 = new JTextArea("Question: How well do you navigate through large datasets to extract meaningful insights and trends?");
	        ...
	        choice2 = new Choices();
		  	...
		  	JTextArea textArea2 = new JTextArea("Question:  Rate your ability to critically assess the validity of experimental results and draw accurate conclusions.");
	        ...
	        choice3.setBackground(getBackground()); 
		  	...
		  	JTextArea textArea3 = new JTextArea("Question: When presented with conflicting data, how skilled are you in reconciling discrepancies and forming a coherent analysis?");
	        ...
	        choice4 = new Choices();
		  	...
		  	JTextArea textArea4 = new JTextArea("Question:Describe a situation where you had to analyze a problem from multiple perspectives. How effective were you in reaching a comprehensive understanding?");
	        ...
	        choice5 = new Choices();
		  	...
		  	JTextArea textArea5 = new JTextArea("Question: How would you rate your ability to identify patterns and trends in scientific or engineering phenomena?");
	        ...
	        choice6 = new Choices();
		  	...
		  	JTextArea textArea6 = new JTextArea("Question: In a research setting, how comfortable are you with proposing and testing hypotheses to address scientific questions?");
	        ...
	        choice7 = new Choices();
		  	...
		  	JTextArea textArea7 = new JTextArea("Question: When tasked with optimizing a process or system, how well can you analyze the existing inefficiencies and propose improvements?");
	        ...
	        choice8 = new Choices();
		  	...
		  	JTextArea textArea8 = new JTextArea("Question: Rate your ability to think critically and make well-reasoned decisions based on available information.");
	        ...
	        choice9 = new Choices();
		  	...
		  	JTextArea textArea9 = new JTextArea("Question:How do you approach problem-solving situations that require both creative thinking and rigorous analysis?");
